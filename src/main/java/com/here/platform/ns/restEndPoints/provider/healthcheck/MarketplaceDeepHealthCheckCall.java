...
public class MarketplaceDeepHealthCheckCall {

    private String endpointUrl = CallsUrl.MARKETPLACE_DEEP_HEALTH_CHECK.builder().getUrl();
    private String callMessage = "Call to get deep health check status for Marketplace service";
