...
public class AccessDeepHealthCheckCall {

    private String endpointUrl = CallsUrl.ACCESS_DEEP_HEALTH_CHECK.builder().getUrl();
    private String callMessage = "Call to get deep health check status for Access service";
